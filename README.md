# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/chriscow/go-openai.svg)](https://pkg.go.dev/github.com/chriscow/go-openai)
[![Go Report Card](https://goreportcard.com/badge/github.com/chriscow/go-openai)](https://goreportcard.com/report/github.com/chriscow/go-openai)
...
### Installation:
```
go get github.com/chriscow/go-openai
```
...
import (
	"context"
	"fmt"
	openai "github.com/chriscow/go-openai"
)
...
See also: https://pkg.go.dev/github.com/chriscow/go-openai#ClientConfig
</details>
...
We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/chriscow/go-openai/graphs/contributors) and sponsors of this project:
